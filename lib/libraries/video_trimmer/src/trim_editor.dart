...
import 'package:lomo/libraries/video_trimmer/src/thumbnail_viewer.dart';
...
class _TrimEditorState extends State<TrimEditor> with TickerProviderStateMixin {
  ...
  Offset _startPos = const Offset(20, 0);
    ...
    widget.trimmer.eventStream.listen((event) {
      if (event == TrimmerEvent.initialized) {
        ...
        setState(() {
          ...
          _endPos = Offset(
            maxLengthPixels != null ? maxLengthPixels! - 20 : _thumbnailViewerW,
            _thumbnailViewerH,
          );
